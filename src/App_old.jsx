...
export default function App() {
  ...
  return (
    <div className={combineClasses(
      ...
      <section className="flex items-center min-h-[80vh] px-6" data-section="hero">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`flex justify-center transition-all duration-1000 delay-300 ease-out ${
            ...
            <div className="w-96 h-96 bg-gray-200 rounded-lg flex items-center justify-center hover:shadow-2xl transition-all duration-300 group">
              <div className="w-24 h-24 bg-gray-300 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="space-y-16">
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ease-out ${
              ...
              <div className={`flex justify-center transition-all duration-1000 delay-200 ease-out ${
                ...
                <div className="w-80 h-64 bg-gray-200 rounded-lg flex items-center justify-center hover:shadow-xl transition-all duration-300 group">
                  <div className="w-16 h-16 bg-gray-300 rounded flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center transition-all duration-1000 delay-300 ease-out ${
              ...
              <div className="order-2 lg:order-1 flex justify-center">
                <div className="w-80 h-64 bg-gray-200 rounded-lg flex items-center justify-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="flex space-x-6">
                  <a href="#" className="text-gray-900 hover:text-gray-700 underline">Explore approach</a>
                  <a href="#" className="text-gray-900 hover:text-gray-700 underline">Book consultation</a>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex space-x-6">
                  <a href="#" className="text-gray-900 hover:text-gray-700 underline">Get started</a>
                  <a href="#" className="text-gray-900 hover:text-gray-700 underline">Start project</a>
                </div>
              </div>
      ...
      <section className="py-20 px-6" data-section="skills">
        <div className="max-w-7xl mx-auto">
          <div className={`mb-12 transition-all duration-1000 ease-out ${
            ...
            <div className="text-sm text-gray-500 font-medium mb-2">Skills</div>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className={`text-center transition-all duration-1000 delay-100 ease-out ${
              ...
              <div className="w-full h-48 bg-gray-200 rounded-lg mb-6 flex items-center justify-center hover:shadow-xl transition-all duration-300 group">
                <div className="w-16 h-16 bg-gray-300 rounded flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clipRule="evenodd" />
                  </svg>
            ...
            <div className={`text-center transition-all duration-1000 delay-200 ease-out ${
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Product strategy</h3>
              <p className="text-gray-600">
            ...
            <div className={`text-center transition-all duration-1000 delay-300 ease-out ${
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Agile methodologies</h3>
              <p className="text-gray-600">
      ...
      {/* Team Section */}
      <section className="py-20 px-6 bg-gray-50" data-section="team">
        <div className="max-w-7xl mx-auto">
          <div className={`mb-12 transition-all duration-1000 ease-out ${
            isVisible.team 
              ? 'opacity-100 translate-y-0' 
            ...
            <div className="text-sm text-gray-500 font-medium mb-2">About</div>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
      ...
      <section className="py-20 px-6" data-section="testimonials">
        <div className="max-w-7xl mx-auto">
          <div className={`mb-12 transition-all duration-1000 ease-out ${
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Client voices</h2>
            <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-medium text-gray-900">Mark Stevens</div>
                  <div className="text-sm text-gray-600">CEO, TechnoCore</div>
                  <div className="flex items-center mt-1">
                    <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2L13.09 8.26L20 9L13.09 9.74L12 16L10.91 9.74L4 9L10.91 8.26L12 2Z"/>
                    </svg>
                    <span className="text-sm text-gray-600">Webflow</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Founder, GreenTech</div>
                  <div className="flex items-center mt-1">
                    <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2L13.09 8.26L20 9L13.09 9.74L12 16L10.91 9.74L4 9L10.91 8.26L12 2Z"/>
                    </svg>
            ...
            <div className="bg-white p-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">CTO, Digital Pioneer</div>
                  <div className="flex items-center mt-1">
                    <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2L13.09 8.26L20 9L13.09 9.74L12 16L10.91 9.74L4 9L10.91 8.26L12 2Z"/>
                    </svg>
      ...
      <section className="py-20 px-6 bg-gray-50" data-section="cta">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-1000 ease-out ${
              isVisible.cta 
              ...
              <div className="flex space-x-4">
                <button className="px-6 py-3 bg-gray-900 text-white rounded-md hover:bg-gray-800 transform hover:scale-105 transition-all duration-200">
                  Start project
                </button>
                <button className="px-6 py-3 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transform hover:scale-105 transition-all duration-200">
                  Schedule call
                </button>
              </div>
            </div>
            <div className={`flex justify-center transition-all duration-1000 delay-200 ease-out ${
              ...
              <div className="w-96 h-64 bg-gray-200 rounded-lg flex items-center justify-center hover:shadow-2xl transition-all duration-300 group">
                <div className="w-24 h-24 bg-gray-300 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-12 h-12 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clipRule="evenodd" />
                  </svg>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                      ...
                      <div className="order-2 lg:order-1">
                        <div className="relative group">
                          <div className="w-full h-80 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
                            <div className="w-24 h-24 bg-gray-300 rounded-lg flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                              <svg className="w-12 h-12 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clipRule="evenodd" />
                              </svg>
                            </div>
                      ...
                      <div className="order-1 lg:order-2 space-y-6">
                        ...
                        <div className="flex space-x-4">
                          ...
                          <button className="px-6 py-3 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors duration-200">
                            View Code
                          </button>
                        </div>
                      </div>
            ...
            <button 
              onClick={prevSlide}
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white shadow-lg rounded-full p-3 hover:bg-gray-50 transition-all duration-200 z-10"
            ...
            <button 
              onClick={nextSlide}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white shadow-lg rounded-full p-3 hover:bg-gray-50 transition-all duration-200 z-10"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex">
                ...
                />
                <button className="px-6 py-3 bg-gray-900 text-white rounded-r-md hover:bg-gray-800">
                  Subscribe
                </button>
              </div>
            ...
            {/* Social Media */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4">Instagram</h3>
              <ul className="space-y-3">
