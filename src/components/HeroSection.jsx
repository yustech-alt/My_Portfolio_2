    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className={combineClasses(
          ...
          isDarkMode 
            ? 'bg-gradient-to-br from-slate-900 via-blue-900/40 to-purple-900/30' 
            : 'bg-gradient-to-br from-blue-100/60 via-indigo-100/40 to-purple-100/30'
        )}></div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            Specialized in React, Node.js, and cloud architecture with 5+ years delivering results.
          </p>
          <div
        ...
        >
          <div
            className={combineClasses(
              "w-96 h-96 rounded-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group",
              isDarkMode ? "bg-gray-700" : "bg-gray-200"
            )}
          >
            <img
              src="/images/profile.jpg" // Or use {profileImage} if importing from assets
              alt="Yuslabi - Full Stack Developer"
